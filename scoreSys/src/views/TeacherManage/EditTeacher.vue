  ...
  <div id="poster">
    <el-form :model="ruleForm"  label-position="left" status-icon ref="ruleForm" :rules="rules" label-width="0px" class="container">
      ...
      <el-form-item label="" prop="teacherName">
        <el-input type="text" v-model="ruleForm.teacherName"placeholder="姓名"></el-input>
      </el-form-item>

      <el-form-item label="" prop="teacherId">
        <el-input type="text" v-model="ruleForm.teacherId" placeholder="工号"></el-input>
      </el-form-item>
...
export default {
  ...
  data(){
    return {
      ruleForm: {
        teacherName: this.$global_msg.editTeacherInfo.userName,
        teacherId:this.$global_msg.editTeacherInfo.userId,
        major:this.$global_msg.editTeacherInfo.major,
      },
      rules: {
        teacherName: [
  ...
  methods:{
    ...
    submitForm(ruleForm) {
      ...
      this.$axios({
        method:'POST',
        url:'http://localhost:8989/updateTeacher',
        data:{
          id:that.$global_msg.editTeacherInfo.id,
